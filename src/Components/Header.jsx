  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 px-5 md:px-0 max-width">
      <div className=" flex justify-between items-center py-2">
        <NavLink to="/">
          <img className="w-16 md:w-20" src={logos.logo} alt="logo" />
        </NavLink>
      ...
      <nav className={` ${!isOpen ? "hidden" : null} text-center md:flex justify-between`}>
        <ul className="font-medium md:flex items-center md:space-x-5 md:mr-10">
          <li className="pb-1 md:pb-0">
            <NavLink to="/" onClick={toggleClass} className= "hover:border-b-2 border-red-500">
              Home
            </NavLink>
          </li>
          <li className="pb-1 md:pb-0 hover:border-b-2 border-red-500">
        ...
        activeClassName = "active">
          ...
          <li className="pb-1 md:pb-0 hover:border-b-2 border-red-500">
            <NavLink to="/technologies"  onClick={(e)=>{
          e.preventDefault();
        ...
        activeClassName = "active" className="hover:border-b-2 border-red-500">
              Contact
            </NavLink>
          </li>
        </ul>
